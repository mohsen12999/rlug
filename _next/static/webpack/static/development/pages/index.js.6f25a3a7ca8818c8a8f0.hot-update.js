...
/* harmony import */ var _db_lugInfo__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../db/lugInfo */ "./db/lugInfo.json");
var _db_lugInfo__WEBPACK_IMPORTED_MODULE_7___namespace = /*#__PURE__*/__webpack_require__.t(/*! ../db/lugInfo */ "./db/lugInfo.json", 1);
...
var Index = function Index(props) {
  ...
  _db_lugInfo__WEBPACK_IMPORTED_MODULE_7__.lugDays.sort(function (a, b) {
    return a.id < b.id;
  }).slice(0, 4).map(function (lug, index) {
    return __jsx("div", {
      key: lug.id,
  ...
  }), props.lugs.map((lug, index))), __jsx("div", {
    className: "row",
    style: moveLeftBtnDiv,
    __source: {
      fileName: _jsxFileName,
  ...
  return _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          _context.next = 2;
          return isomorphic_unfetch__WEBPACK_IMPORTED_MODULE_8___default()('https://apdr.ir/api/lugs/4');
...
//# sourceMappingURL=index.js.6f25a3a7ca8818c8a8f0.hot-update.js.map